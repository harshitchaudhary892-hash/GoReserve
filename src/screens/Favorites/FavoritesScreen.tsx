...
export const FavoritesScreen: React.FC<FavoritesScreenProps> = ({ navigation }) => {
  ...
  const loadFavorites = useCallback(async () => {
    ...
    try { const favs = await getFavoritePlaces(userProfile.favorites); setPlaces(favs as Place[]); } catch (e) { console.error(e); } finally { setLoading(false); }
